...
var useless_facts = ["Most American car horns honk in the key of F.",
...
requestPortButton.addEventListener("pointerdown", async(event) => {
    ...
    console.log(state);
    readJSONFromArduino("joystick", );
});


// This function will read data from the Arduino
const readJSONFromArduino = async(propertyName, ) => {
    ...
    while (true) {
        ...
        if (state.joystick.pressed) {
            ...
            let x = Math.round(Math.random() * useless_facts.length - 1);
            ourFact = useless_facts[x];
        }
        const textField = document.querySelector(".container")
        textField.innerHTML = ourFact;
...
//module.exports = {useless_facts: useless_facts};